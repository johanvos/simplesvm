...
SVMLIB=$SVMBUILD/lib
echo "Compile src\n============"
$JAVA_HOME/bin/javac -p $JFXLIB --add-modules javafx.controls,javafx.fxml -d class src/java/HelloFX.java
...
-imagecp $SVMLIB/jvmci/graal-sdk.jar:$SVMLIB/jvmci/graal.jar:$SVMLIB/svm/builder/objectfile.jar:$SVMLIB/svm/builder/pointsto.jar:$SVMLIB/svm/builder/svm.jar:$SVMLIB/svm/library-support.jar:$JFXLIB/javafx.base.jar:$JFXLIB/javafx.graphics.jar:$JFXLIB/javafx.controls.jar:$JFXLIB/javafx.fxml.jar:$PWD/class \
-H:Path=$PWD/image \
-H:CLibraryPath=$SVMLIB/svm/clibraries/linux-amd64 \
-H:Class=HelloFX \
-H:ReflectionConfigurationFiles=reflectionconfig-linux-fxml.json \
