...
echo "linking\n=======\n"
echo "gcc -isysroot $SDK -fobjc-arc -o build/mac/hellofxsvm -Wl,-exported_symbols_list,release.symbols build/mac/AppDelegate.o build/mac/launcher.o $1/hellofxsvm.o -L$JFXLIB -L$SVMBUILD/lib/svm/clibraries/darwin-amd64 -L/Users/johan/openjdk/jdk/build/macosx-x86_64-server-release/jdk/lib -lffi -lpthread -lz -ldl -lstrictmath -llibchelper -lprism_es2 -lglass -ljavafx_font -ljava -lnio -lzip -lnet /Users/johan/graal/github/fork/graal//substratevm/mxbuild/darwin-amd64/SVM_GRAALVM_SUPPORT/builder/clibraries/darwin-amd64/libjvm.a -Wl,-framework,Foundation -Wl,-framework,AppKit -Wl,-framework,ApplicationServices -Wl,-framework,OpenGL -Wl,-framework,QuartzCore -Wl,-framework,Security"
gcc -ObjC -isysroot $SDK -iframework$SDK/System/Library/Frameworks -arch x86_64 -o build/mac/hellofxsvm -Wl,-exported_symbols_list,release.symbols build/mac/AppDelegate.o build/mac/launcher.o $1/hellofxsvm.o -L$JFXLIB -L$SVMBUILD/lib/svm/clibraries/darwin-amd64 -L/Users/johan/openjdk/jdk/build/macosx-x86_64-server-release/jdk/lib -lffi -lpthread -lz -ldl -lstrictmath -llibchelper -lprism_es2 -lglass -ljavafx_font -ljava -lnio -lzip -lnet /Users/johan/graal/github/fork/graal//substratevm/mxbuild/darwin-amd64/SVM_GRAALVM_SUPPORT/builder/clibraries/darwin-amd64/libjvm.a -Wl,-framework,Foundation -Wl,-framework,AppKit -Wl,-framework,ApplicationServices -Wl,-framework,OpenGL -Wl,-framework,QuartzCore -Wl,-framework,Security -lobjc
echo "running\n=======\n"
#./build/mac/hellofx
