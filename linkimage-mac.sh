...
echo "linking\n=======\n"
gcc -isysroot $SDK -o build/mac/hellofx  build/mac/AppDelegate.o build/mac/launcher.o $1/hellofxsvm.o -L$SVMBUILD/lib/svm/clibraries/darwin-amd64 -lffi -Wl,-framework,CoreFoundation -Wl,-framework,Appkit -lpthread -lz -ldl -lstrictmath -llibchelper
echo "running\n=======\n"
./build/mac/hellofx
